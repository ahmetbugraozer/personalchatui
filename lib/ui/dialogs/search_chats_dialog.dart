  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        // Check if there are any chats at all (not filtered)
        final bool hasAnyChats = chat.nonEmptySessionIndices.isNotEmpty;
